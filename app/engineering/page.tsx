...
export default function EngineeringPage() {
  return (
    <>
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-5 py-16 sm:px-8 lg:grid-cols-[.95fr_1.05fr] lg:py-20">
        <SectionHeading
      ...
      <section className="border-y border-warmIvory/10 bg-warmIvory/[0.035]">
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:py-20">
          <SectionHeading eyebrow="Skills" title="Technical strengths and coordination habits." />
          <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {engineeringSkills.map((skill) => (
              <div key={skill} className="rounded-md border border-mutedGold/20 bg-richBlack/70 px-4 py-4 text-sm font-bold text-warmIvory/82">
                {skill}
              </div>
            ))}
          </div>
      ...
      <section className="mx-auto max-w-5xl px-5 py-16 sm:px-8 lg:py-20">
        <Card tone="outlined" className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-warmIvory/74">
